...
# import class models
from .sagan_model import Generator, Discriminator
from .utils import *
    ...
    def train(self):
        ...
        for step in range(start, self.total_step):
            ...
            if (step + 1) % self.log_step == 0:
                ...
                sys.stdout = open(f'{self.log_path}/train.log', 'a')
                print("Elapsed [{}], G_step [{}/{}], D_step[{}/{}], d_out_real: {:.4f}, "
                      " ave_gamma_l3: {:.4f}, ave_gamma_l4: {:.4f}".
                      format(elapsed, step + 1, self.total_step, (step + 1),
                             self.total_step , d_loss_real.data.item(),
                             self.G.module.attn1.gamma.mean().item(), self.G.module.attn2.gamma.mean().item() ))
                sys.stdout.close()
            # Sample images
